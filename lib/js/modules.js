...
var modules = function modules() {
  return {
    ...
    delete: function (input) {
      return util.promiseResponse(util.constructRequestDetails(input, input.module + "?ids={id}", HTTP_METHODS.DELETE, false)); //No I18N
    },
    ...
    coql: function (input) {
      return util.promiseResponse(util.constructRequestDetails(input, "coql", HTTP_METHODS.POST, false)); //No I18N
    },
    upsert: function (input) {
      return util.promiseResponse(util.constructRequestDetails(input, input.module + "/upsert", HTTP_METHODS.POST, false)); //No I18N
    },
  };
};
